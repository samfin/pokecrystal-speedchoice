...
; battle types
	...
	const BATTLETYPE_MOTHERFUCK
	const BATTLETYPE_ATTRACT
	const BATTLETYPE_SHADOWTAG
	const BATTLETYPE_FISTFIGHT
	const BATTLETYPE_STURDY
	const BATTLETYPE_WINTER
	const BATTLETYPE_MULTISCALE
	const BATTLETYPE_TELEKINESIS
	const BATTLETYPE_DISGUISE
	const BATTLETYPE_JANINE_DISGUISE
	const BATTLETYPE_WONDERGUARD
	const BATTLETYPE_TRICKROOM
	const BATTLETYPE_SANDSTORM
	const BATTLETYPE_BURNHEAL
	const BATTLETYPE_PRESSURE
...
SUBSTATUS_CURLED       EQU 0
	...
	enum SUBSTATUS_PRESSURE_RECHARGE
